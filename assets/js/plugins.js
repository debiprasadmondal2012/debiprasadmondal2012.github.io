...
!function () {
    ...
    function t() {
        if (!z && document.body) {
            ...
            if (X = document.compatMode.indexOf("CSS") >= 0 ? o : t,
                ...
                r.style.cssText = "position:absolute; z-index:-10000; top:0; left:0; right:0; height:" + X.scrollHeight + "px",
            ...
            T.fixedBackground || H || (t.style.backgroundAttachment = "scroll",
    ...
    function o(e, t, o) {
        if (h(t, o),
            ...
            if (a < T.accelerationDelta) {
                var r = (1 + 50 / a) / 2;
                r > 1 && (r = Math.min(r, T.accelerationMax),
                    t *= r,
                    o *= r)
            }
            N = Date.now()
        ...
        if (A.push({
            ...
            var l = e === document.body
                , i = function (n) {
                    ...
                    l ? window.scrollBy(r, c) : (r && (e.scrollLeft += r),
                        c && (e.scrollTop += c)),
                        t || o || (A = []),
    ...
    function n(e) {
        ...
        var n = e.target
            , a = c(n);
        if (!a || e.defaultPrevented || e.ctrlKey)
            return !0;
        if (m(S, "embed") || m(n, "embed") && /\.pdf/i.test(n.src) || m(S, "object"))
            return !0;
        var r = -e.wheelDeltaX || e.deltaX || 0
            , i = -e.wheelDeltaY || e.deltaY || 0;
        return B && (e.wheelDeltaX && w(e.wheelDeltaX, 120) && (r = -120 * (e.wheelDeltaX / Math.abs(e.wheelDeltaX))),
            e.wheelDeltaY && w(e.wheelDeltaY, 120) && (i = -120 * (e.wheelDeltaY / Math.abs(e.wheelDeltaY)))),
            r || i || (i = -e.wheelDelta || 0),
            1 === e.deltaMode && (r *= 40,
                i *= 40),
            !T.touchpadSupport && p(i) ? !0 : (Math.abs(r) > 1.2 && (r *= T.stepSize / 120),
    ...
    function a(e) {
        ...
        if (a.test(t.nodeName) || m(t, "input") && !r.test(t.type) || m(S, "video") || b(e) || t.isContentEditable || e.defaultPrevented || n)
            return !0;
        if ((m(t, "button") || m(t, "input") && r.test(t.type)) && e.keyCode === L.spacebar)
            return !0;
    ...
    function y(e) {
        return e >= 1 ? 1 : 0 >= e ? 0 : (1 == T.pulseNormalize && (T.pulseNormalize /= g(1)),
            g(e))
    }
    var S, x, D, k, M = {
        frameRate: 150,
        ...
        x: 0,
        y: 0
    }, z = !1, X = document.documentElement, Y = [], B = /^Mac/.test(navigator.platform), L = {
        left: 37,
        up: 38,
        right: 39,
        down: 40,
        ...
        home: 36
    }, T = M, A = [], K = !1, N = Date.now(), q = function () {
        var e = 0;
        return function (t) {
